...
public class RedFar extends LinearOpMode {
    ...
    public void build_paths() {
        ...
        TrajectoryActionBuilder intakeSpike1 = preloadsShoot.fresh()
                ...
                .splineToLinearHeading(new Pose2d(-23.3,19,Math.toRadians(360-250)), Math.toRadians(360-15),
                        new TranslationalVelConstraint(40))

                .splineToSplineHeading(new Pose2d(-12,40,Math.toRadians(360-270)),Math.toRadians(360-270),
                        new TranslationalVelConstraint(40))
