...
class ForwardZeroPowerAccelerationTuner extends OpMode {
    ...
    /** This initializes the drive motors as well as the Panels telemetryA. */
    @Override
    public void init_loop() {
...
class TranslationalTuner extends OpMode {
    ...
    /** This runs the OpMode, updating the Follower as well as printing out the addLine statements to the Telemetry */
    @Override
    public void loop() {
        follower.update();
        draw();
...
class HeadingTuner extends OpMode {
    ...
    /**
     * This runs the OpMode, updating the Follower as well as printing out the addLine statements to
